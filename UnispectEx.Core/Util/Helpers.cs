...
namespace UnispectEx.Core.Util {
    public static class Helpers {
        public static IEnumerable<Tuple<TypeDef, MonoClass>> CorrelateClasses(IEnumerable<TypeDef> typeDefs, IEnumerable<MonoClass> monoClasses) {
        ...
        public static IEnumerable<Tuple<FieldDef, MonoClassField>> CorrelateFields(IEnumerable<FieldDef> fieldDefs, IEnumerable<MonoClassField> classFields) {
